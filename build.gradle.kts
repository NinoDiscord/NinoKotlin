...
dependencies {
    ...
    // JDA
    implementation("net.dv8tion:JDA:4.2.0_235") {
    ...
    // Testing tools
    testImplementation("io.kotest:kotest-runner-junit5-jvm:4.4.2")
    testImplementation("io.kotest:kotest-assertions-core-jvm:4.4.2")
    testImplementation("io.kotest:kotest-property-jvm:4.4.2")
    testImplementation("io.kotest:kotest-extensions-koin-jvm:4.4.2")
